...
if __name__ == "__main__":
    ...
    train_dataset = EpochDataset(feature_paths[0:8], CLASS_MAP)
    valid_dataset = EpochDataset(feature_paths[8:10], CLASS_MAP)
    ...
    for training_epoch in range(NUM_TRAINING_EPOCHS):
        train_loss, train_accuracy = train(model, device, train_loader, criterion, optimizer, training_epoch, print_freq=50)
