...
if __name__ == "__main__":
    ...
    valid_dataset = EpochDataset(feature_paths[2:3])
    ...
    for training_epoch in range(NUM_TRAINING_EPOCHS):
        train_loss, train_accuracy = train(model, device, train_loader, criterion, optimizer, training_epoch, print_freq=10)
